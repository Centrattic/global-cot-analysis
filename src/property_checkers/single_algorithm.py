...
class PropertyCheckerSingleAlgorithm(PropertyCheckerMulti):
    ...
    def __init__(
        ...
        super().__init__("single_algorithm")
        self.prompt_template = prompt_template or """Study the given Chain of Thought (COT) and final response to determine which algorithm was used.

Available algorithms:
{algorithms}

Return only a single algorithm number between <alg> and </alg> tags, like this: <alg>1</alg>."""
