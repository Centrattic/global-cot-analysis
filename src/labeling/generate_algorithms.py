        ...
        if FileUtils.file_exists(rollout_path):
            try:
                ...
                rollout_info = {
                    ...
                    "processed_response_content": rollout_data.get("processed_response_content", ""),
...
def generate_algorithms_prompt(prompt_text: str, rollouts: List[Dict[str, Any]], num_rollouts: int) -> str:
        ...
        try:
            ...
            if algorithms is None:
                ...
                if attempt < max_retries - 1:
                    ...
                    raise ValueError("Failed to extract JSON from LLM response after multiple attempts")
            ...
            if is_valid:
                ...
                if attempt < max_retries - 1:
                    ...
                    raise ValueError(f"Invalid algorithms format after {max_retries} attempts: {error_msg}")
